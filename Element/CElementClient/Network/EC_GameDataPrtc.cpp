...
{\
	...
	case ASTROLABE_OPERATE_RESULT: dwSize = sizeof(astrolabe_operate_result); break;
	default:
		break;
	}
...
/*
	...
	*/
	...
	case ASTROLABE_INFO_NOTIFY:
		...
		break;
	case ASTROLABE_OPERATE_RESULT:
		pGameRun->PostMessage(MSG_HST_ASTROLABE_OPERATE_RESULT, MAN_PLAYER, 0, (DWORD)pDataBuf, pCmdHeader->cmd);
		break;
	default:
		break;
	}
